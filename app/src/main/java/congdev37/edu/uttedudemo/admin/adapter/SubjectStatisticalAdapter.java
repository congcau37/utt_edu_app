...
public class SubjectStatisticalAdapter extends RecyclerView.Adapter<SubjectStatisticalAdapter.ViewHolder> {
    ...
    public SubjectStatisticalAdapter(List<Subject> mDatasets) {
